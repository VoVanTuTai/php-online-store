     ...
     <!--Container chứa toàn bộ trang-->
        ...
        <div class="row"><!-- Bài viết start -->
                <h2 style="
                    ...
                    font-size: 30px;
                ">
                    <strong>...CÁC BÀI VIẾT CỦA SONG TÀI FOOD<i class="fas fa-seedling"></i></strong>
                </h2>
                <div class="baiviet-container">
                    <?php
                        require_once "../class_models/class_baiviet.php"; 

                        $database = new Database();
                        $baiviet = new Baiviet($database);
                        $baiviet->suatBaiViet(3); // Hiển thị 3 bài viết mới nhất
                    ?>
                </div>
        </div> <!-- end bài viết -->
 <!-- foooter start -->
